      ...
      >
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 mt-8">
          ...
          <div className="md:col-span-2 flex flex-col gap-8">
            ...
            {/* Large Description */}
            <div>
              <h4 className="font-display text-xs font-bold uppercase tracking-widest text-[#8a8a8f]">
                Project Overview
              </h4>
              <p className="mt-4 font-body text-sm leading-relaxed text-[#8a8a8f] md:text-base">
          ...
          <div className="flex flex-col gap-8 border-t border-white/5 pt-8 md:border-t-0 md:pt-0 md:border-l md:border-white/5 md:pl-8">
            ...
            <div>
              ...
              <p className="mt-2 font-body text-sm leading-relaxed text-[#f2f1ed]">
                {activeProject.role}
              </p>
            </div>
            ...
            <div className="rounded-xl bg-[#ffb44f]/[0.02] border border-[#ffb44f]/10 p-4">
              <h5 className="flex items-center gap-1.5 font-display text-xs font-bold uppercase tracking-widest text-[#ffb44f]">
            ...
            <div>
              ...
              <ul className="mt-3 flex flex-col gap-2">
                {activeProject.features.map((feature) => (
                  <li key={feature} className="flex items-start gap-2 text-sm text-[#8a8a8f]">
                    <span className="mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#ffb44f]" />
                    <span>{feature}</span>
                  </li>
                ))}
              </ul>
        ...
        <div className="mt-8 border-t border-white/5 pt-6 flex flex-wrap gap-4 items-center justify-between">
          <div className="flex gap-4">
            <Magnetic range={30}>
              <a
                ...
                onMouseEnter={() => setCursor('hover')}
                onMouseLeave={() => setCursor('default')}
                className="flex items-center gap-2 rounded-full border border-white/15 bg-[#141416] px-6 py-3 text-sm font-bold uppercase tracking-wider text-[#f2f1ed] hover:border-[#ffb44f] hover:text-[#ffb44f] transition-all"
              >
            ...
            {activeProject.live !== '#' && (
              <Magnetic range={30}>
                <a
                  ...
                  onMouseEnter={() => setCursor('hover')}
                  onMouseLeave={() => setCursor('default')}
                  className="flex items-center gap-2 rounded-full bg-[#ffb44f] px-6 py-3 text-sm font-black uppercase tracking-wider text-[#0b0b0d] hover:bg-[#f2f1ed] transition-colors"
                >
          ...
          <button
            onClick={() => setActiveProject(null)}
            className="text-xs font-bold uppercase tracking-widest text-[#8a8a8f] hover:text-[#ffb44f] transition-colors"
          >
            Back to Stack
          </button>
        </div>
